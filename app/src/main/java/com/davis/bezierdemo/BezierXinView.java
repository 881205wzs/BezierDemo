...
/**
 * Created by davis on 19/7/10.
 */

public class BezierXinView extends View {
    ...
    public BezierXinView(Context context) {
        this(context, null);
    }

    public BezierXinView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BezierXinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
